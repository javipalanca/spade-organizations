...
"""
Probando que el owner añada una regla para los metadatos:
Ej: Que ningún miembro con el rol empleado pueda añadir reglas
...
r1 = Rule("Empleado", "Owner", {"performative":"request", "org_action":"add_rule"}, None)
print("Regla 1: ", r1)
owner_agent.organization.add_rule(r1)

r2 = Rule("Empleado", "Empleado", None, None)
